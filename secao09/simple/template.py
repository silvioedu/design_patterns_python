...
class CompiladorIOS(Compilador):
  ...
  def coletar_fonte(self):
    print(f'Coletando  código fonte Swift')
  
  def compilar_objeto(self):
    print(f'Compilando código Swift para bytecode LLVM')
  
  def executar(self):
    print(f'Programa executando no ambiente de execução')


class CompiladorAndroid(Compilador):

  def coletar_fonte(self):
    print(f'Coletando  código fonte Kotlin')
  
  def compilar_objeto(self):
    print(f'Compilando código Kotlin para bytecode JVM')
